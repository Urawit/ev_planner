...
class ResultWithoutChargesPageDataModel {
  const ResultWithoutChargesPageDataModel(
...
class ResultWithoutChargePage extends ConsumerStatefulWidget {
  const ResultWithoutChargePage({
    required this.data,
    super.key,
  });

  final ResultWithoutChargesPageDataModel data;

  @override
  ResultWithoutChargePageState createState() => ResultWithoutChargePageState();
}

class ResultWithoutChargePageState
    extends ConsumerState<ResultWithoutChargePage> {
